 ...
 * MCP HTTP server running in the MCP Link application and exposing
...
function parseArgs(args: string[]): { baseUrl: string } {
    ...
    try {
      ...
      try {
        ...
        if (fetchError.code === "ECONNREFUSED") {
          throw new Error(
            `Connection refused at ${this.baseUrl}. Make sure the MCP Link is running.`,
          );
      ...
      console.error("Make sure the MCP Link is running");
      console.error(
