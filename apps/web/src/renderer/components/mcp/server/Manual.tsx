...
import { Textarea } from "@mcp_link/ui";
import { Alert, AlertDescription, AlertTitle } from "@mcp_link/ui";
...
import { MCPServerConfig } from "@mcp_link/shared";
import { Checkbox } from "@mcp_link/ui";
import { RadioGroup, RadioGroupItem } from "@mcp_link/ui";
...
const Manual: React.FC = () => {
  ...
  const handleDxtFileSelect = async (
    ...
    if (!file) return;
    if (!file.name.endsWith(".dxt") && !file.name.endsWith(".mcpb")) {
